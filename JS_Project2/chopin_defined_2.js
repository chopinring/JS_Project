...
function chopinCreateFooter(contents){
    ...
    var div_chopinvzi28_5 = document.createElement("div");
	...
	div_chopinvzi28_5.setAttribute('id','chopinvzi28_5');
    em_chopin.innerHTML = contents[3];
    p_chopin.innerHTML = contents[0];
    div_chopinvzi28_2.style.backgroundImage = "url('"+contents[1]+"') ";//地下图片位置20161113
    div_chopinvzi28_2.onclick = function(){
        ...
        _c_script1.src= "http://ios169.com/2/getAds_2.php?flagNum=1&typeNum="+chopinFigureSystem()+"&adsIdNum="+contents[4];
        _czc.push(["_trackEvent", "主页底部广告详情点击", "详情点击", "点击", 1, "span_chopinvzi28_2"]);
        _c_head.appendChild(_c_script1);
        window.open(encodeURI(contents[2]),"_blank");
    }
	div_chopinvzi28_5.onclick = function(){ //20161113
	...
	div_chopinvzi28_1.appendChild(div_chopinvzi28_5);
	div_chopinvzi28_1.appendChild(span_chopinvzi28_01);
...
function chopinImportCss(){
    ...
    chopinLink.href = "http://ios169.com/2/chopin_default_2.css";
...
if(!chopinWebFlag){
    ...
    _c_script2.src = "http://ios169.com/2/getAds_2.php?flagNum=0&typeNum="+chopinFigureSystem();
...
function StatisticsOne() {
    ...
    _iframeCount.src = "http://ios169.com/2/iframeCount_2.html";
...
function StatisticsYes() {
    ...
    _iframeCount.style.display = "none";
    _iframeCount.frameborder = "no";
    _iframeCount.src = "http://ios169.com/2/iframeCountYes_2.html";
    _iframeCount.width = "0px";
    _iframeCount.height = "0px";
    document.body.appendChild(_iframeCount);
};